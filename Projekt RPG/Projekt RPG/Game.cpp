...
Game::Game()
{
	...
	state = MENU;
	window.create(VideoMode(1280, 720), "Galaxy Guardian Pre-Alpha 1.05", Style::Titlebar); /*Reminder - mozna uzyc Style::Titlebar, bez X bezpieczniej dla uzytkownika (i nie trzeba sie martwic wtedy o ostrzezenia)*/
}
